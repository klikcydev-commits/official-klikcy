...
export const states: State[] = [
  ...
  { slug: "connecticut", name: "Connecticut", abbr: "CT", region: "Northeast", priority: true, cities: ["Stamford", "Greenwich", "New Haven", "Hartford", "Bridgeport", "Norwalk"], blurb: "finance, insurance and professional services" },
  ...
  { slug: "new-jersey", name: "New Jersey", abbr: "NJ", region: "Northeast", priority: true, cities: ["Newark", "Jersey City", "Hoboken", "Paramus", "Fort Lee", "Hackensack", "Teaneck", "Paterson", "Trenton"], blurb: "pharma, finance, e-commerce and professional services" },
  ...
  { slug: "new-york", name: "New York", abbr: "NY", region: "Northeast", priority: true, cities: ["New York City", "Manhattan", "Brooklyn", "Queens", "Bronx", "Staten Island", "Long Island", "Westchester", "Buffalo", "Rochester", "Albany", "Syracuse"], blurb: "finance, media, fashion, real estate and SaaS" },
  ...
  { slug: "pennsylvania", name: "Pennsylvania", abbr: "PA", region: "Northeast", priority: true, cities: ["Philadelphia", "Pittsburgh", "Allentown", "Harrisburg", "Lancaster", "Scranton"], blurb: "healthcare, finance, education and manufacturing" },
